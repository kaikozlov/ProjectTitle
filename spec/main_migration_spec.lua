...
describe("Main Settings Migration", function()
    ...
    describe("Version 10 to 11 migration", function()
        it("adds footer device-info toggle settings", function()
            BookInfoManager:saveSetting("config_version", "10")
            ...
            assert.equal("11", BookInfoManager:getSetting("config_version"))
    ...
    describe("Full migration path", function()
        it("successfully migrates from version 1 to version 11", function()
            BookInfoManager:saveSetting("config_version", "1")
